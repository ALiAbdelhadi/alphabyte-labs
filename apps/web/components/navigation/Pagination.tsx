    ...
    <div>
      <div className="flex flex-col sm:flex-row justify-between my-12 gap-4">
        <div className="w-full sm:w-1/2">
          {res.prev && (
            <Link
              className="w-full border border-gray-200 rounded-lg flex flex-col !py-4 !px-4 !items-start font-medium not-prose hover:bg-gray-50 transition-colors"
        ...
        <div className="w-full sm:w-1/2 flex justify-end">
          {res.next && (
            <Link
              className="w-full border border-gray-200 rounded-lg flex flex-col !py-4 !px-4 !items-end text-right font-medium not-prose hover:bg-gray-50 transition-colors"
