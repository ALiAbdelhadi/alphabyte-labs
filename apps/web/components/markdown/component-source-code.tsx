...
export default function ComponentSource({
    ...
    const ComponentUtilsText = () => {
        return (
            <p>Third, you need to create a new folder called <MdxBadge>component</MdxBadge> in you root directory and create a new file called <MdxBadge>{componentName}</MdxBadge> </p>
        )
    }
    return (
