...
import { services } from '@/constant/blocks';
                        ...
                        >
                            <div className="group flex items-center justify-between cursor-pointer">
                                <Link href={service.link} className="space-y-2 flex-1">
                                    <h3
                                        className={`text-xl md:text-2xl lg:text-3xl font-medium transition-colors duration-300 ${activeService === index
                                            ? 'text-foreground'
                                    ...
                                    <p
                                        className={`text-base md:text-lg leading-5 lg:leading-[1.4] transition-all duration-500 md:max-w-xl max-w-[240px] overflow-hidden ${activeService === index
