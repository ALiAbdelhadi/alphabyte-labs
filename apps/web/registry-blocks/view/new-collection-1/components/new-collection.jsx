      ...
      <Container>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="relative">
            ...
            <h3 className="mb-2 text-lg font-medium text-amber-800">HALO — LED RING SUSPENDED LAMP</h3>
            <Link href="#" className="text-sm text-gray-700 hover:text-amber-800 hover:underline">
              Discover more
            </Link>
          </div>
          <div className="relative">
            ...
            <h3 className="mb-2 text-lg font-medium text-amber-800">LINE — UP/DOWN LED SUSPENDED LAMP</h3>
            <Link href="#" className="text-sm text-gray-700 hover:text-amber-800 hover:underline">
              Discover more
            </Link>
          </div>
