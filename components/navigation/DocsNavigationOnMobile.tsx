...
export function DocsNavigationOnMobile() {
  ...
  return (
    <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
      <div
        className={cn(
          "md:hidden h-14 fixed top-[56px] border-b border-t border-gray-300 left-0 right-0 z-50 bg-[rgba(250,250,252,0.4)] dark:bg-[#e2e8f003] backdrop-blur-lg backdrop-filter backdrop-saturate-[200%] transition-all duration-300"
        )}
      >
      ...
      <SheetContent
        ...
        style={{
          transition:
            "transform 0.5s cubic-bezier(0.32, 0.72, 0, 1), opacity 0.5s ease-out",
        }}
