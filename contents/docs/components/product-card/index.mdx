...
`}
   ...
   <StepItem>
   Now you can create in your <ProseBadge>components</ProseBadge> a <ProseBadge>ProductCard.tsx</ProseBadge> file and add the following code in it :
   <Pre className="language-typescript" folderPath="components/ProductCard.tsx">
   {`"use client"
