...
<StepItem title="Create Button component">
  Now you can create in your <ProseBadge>components</ProseBadge> a <ProseBadge>tab.tsx</ProseBadge> file and add the following code in it :
  <CodeBlockWrapper>
