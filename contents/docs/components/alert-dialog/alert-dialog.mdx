...
<ComponentPreview name="alert-dialog-top-demo" />

#### Bottom position

<ComponentPreview name="alert-dialog-bottom-demo" />
### Adding custom size
#### Large size

<ComponentPreview name="alert-dialog-lg-demo"  />

#### Small Size

<ComponentPreview name="alert-dialog-demo-sm" />
